...
- [React Router Organizations/Workspaces hooks](/sdks/react-router/hooks/organizations-workspaces)
- [TanStack Router Organizations/Workspaces hooks](/sdks/tanstack-router/hooks/organizations-workspaces)
- [Next.js Organizations/Workspaces hooks](/sdks/nextjs/hooks/organizations-workspaces)

## Backend implementation

Use backend SDK methods and scope-aware checks:

- [Rust Organizations and Workspaces](/sdks/rust/organizations-workspaces)
...
For the corresponding webhook events fired by these operations (`organization.invitation.created`, `.accepted`, `.revoked`), see [Webhooks → keep your backend in sync](/guides/deployment-events).
...
- [Frontend API org/workspace surfaces](/reference/frontend-api)
- [Backend API org/workspace surfaces](/reference/backend-api)
