...
Each scheduled task is a board item under an actor project. If you don't already have a project for the agent, create one first — see the [agent runtime reference](/reference/agent-objects).
