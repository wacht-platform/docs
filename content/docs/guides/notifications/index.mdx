...
2. [Frontend Inbox with Hooks](/guides/notifications/frontend-inbox-with-hooks)
3. [Realtime Stream Handling](/guides/notifications/realtime-stream-handling)
4. [React Router Notifications Hooks](/sdks/react-router/hooks/notifications)
