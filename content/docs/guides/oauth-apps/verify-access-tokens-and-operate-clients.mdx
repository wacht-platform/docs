...
1. [Node SDK Gateway Authz](/sdks/node/server-auth)
2. [Node SDK OAuth Apps API](/sdks/node)
3. [Rust SDK OAuth Apps Guide](/sdks/rust/api-auth-oauth)
4. [Backend API Reference](/reference/backend-api)
5. [Frontend OAuth Consent API Reference](/reference/frontend-api)
