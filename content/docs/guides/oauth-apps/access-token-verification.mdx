...
1. [Use Wacht as an OpenID Connect Provider](/guides/oauth-apps/use-as-openid-connect-provider)
2. [Implement the OAuth Consent Flow](/guides/oauth-apps/implement-consent-flow)
3. [Operate OAuth Clients](/guides/oauth-apps/verify-access-tokens-and-operate-clients)
4. [Node SDK Server Auth](/sdks/node/server-auth)
5. [Rust SDK OAuth Apps](/sdks/rust/api-auth-oauth)
