...
wacht mcp config --client claude
wacht mcp config --client codex
```

The output is JSON you paste into your editor's MCP config:

```json
{
  "mcpServers": {
    "wacht-docs": { "url": "https://wacht.dev/docs/mcp" }
  }
}
```
...
`wacht init` writes most of this for you, including a project-scoped `AGENTS.md` block and a `.wacht/BOOTSTRAP.md` guide.
