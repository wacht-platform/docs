...
description: Use the React Router client-side helpers for hosted auth pages, signed-in UI, account management, and custom auth flows.
---

Once the auth model is clear, the client-side API is straightforward.

The React Router adapter gives you the pieces you need for:
...
This is the simplest way to wire auth-aware UI into a React Router app.
