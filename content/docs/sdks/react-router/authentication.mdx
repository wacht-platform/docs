...
description: Understand how Wacht models sessions, sign-ins, memberships, sign-out, and session tokens in React Router apps.
---

Before you wire anything into routes, it helps to understand how Wacht thinks about authentication.

The React Router adapter follows the same core model as the rest of Wacht:
...
## `uiOverrides` is useful for embedded auth flows

If you are building sign-in, sign-up, account, or profile surfaces inside your app, `uiOverrides` lets you adjust the UI-facing deployment settings for that embedded experience.
