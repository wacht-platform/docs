...
pub async fn api_auth_and_oauth_example(client: &WachtClient) -> Result<()> {
    let _scheme = client
        .api_keys()
        .create_rate_limit_scheme(wacht::api::api_keys::CreateRateLimitSchemeRequest {
            ...
            rules: vec![wacht::api::api_keys::RateLimit {
                unit: wacht::api::api_keys::RateLimitUnit::Minute,
                duration: 1,
                max_requests: 120,
                mode: Some(wacht::api::api_keys::RateLimitMode::PerKey),
            }],
        })
        .send()
        .await?;
    ...
    let _oauth_app = client
        ...
        .update_oauth_app(
            "acme-oauth",
            wacht::models::UpdateOAuthAppRequest {
