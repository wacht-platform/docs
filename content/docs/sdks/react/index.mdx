...
Use your server runtime with [Backend JS SDK](/sdks/node) or [Rust SDK](/sdks/rust/getting-started), and keep protected APIs behind server-side session/token validation.
</Steps>
...
If you can adopt one supported adapter, prefer [React Router](/sdks/react-router), [TanStack Router](/sdks/tanstack-router), or [Next.js](/sdks/nextjs) for built-in request helpers.
