...
## `uiOverrides` is most useful when you embed auth inside your app

If you are building sign-in, sign-up, account, or profile surfaces inside your own app, `uiOverrides` gives you a way to adjust the UI-facing deployment settings for that embedded experience.
