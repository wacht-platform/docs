...
| SDK | Install |
|-----|---------|
| [Next.js SDK](/sdks/nextjs/quickstart) | `npm install @wacht/nextjs` |
| [React Router SDK](/sdks/react-router/quickstart) | `npm install @wacht/react-router` |
| [TanStack Router SDK](/sdks/tanstack-router/quickstart) | `npm install @wacht/tanstack-router` |
